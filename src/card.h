...
card_t card_scale[SCALE_LENGTH] = {
    {.suit=Espada, .value=1},
    {.suit=Basto, .value=1},
    {.suit=Espada, .value=7},
    {.suit=Oro, .value=7},
...
card_value_t possible_values[VALUES_QUANTITY] = {1,2,3,4,5,6,7,10,11,12};
card_suit_t possible_suits[SUIT_QUANTITY] = {Basto, Copa, Espada, Oro};
